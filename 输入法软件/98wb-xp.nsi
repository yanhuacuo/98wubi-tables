...
; File "data\weasel.custom.yaml"
  ...
  SetOutPath "$FONTS"  
  File "98WB.otf"
  StrCpy $0 "$FONTS\98WB.otf"
  WriteRegStr HKLM "SOFTWARE\Microsoft\Windows NT\CurrentVersion\Fonts" "98WB" "$0"
